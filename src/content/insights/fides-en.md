...
Aureus Sigma Capital designs, tests, and maintains the rules that govern how portfolios are built and risk is managed. The research process blends market data, company information, and predefined guardrails.

FIDES is responsible for offering and managing any investment products that may use ASC’s strategies, including onboarding clients, executing portfolios, monitoring positions, and reporting under Vietnamese regulations.

Under the partnership, ASC provides its rulebook, research updates, and risk oversight; FIDES determines how the strategies are deployed within its licensed vehicles. ASC does not offer products directly to the public and does not handle client funds.
