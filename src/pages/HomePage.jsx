    ...
    return (
        <div>
            <SEO
                ...
                description="Aureus Sigma Capital develops disciplined quantitative processes for Vietnam’s capital markets, combining data, algorithms, quantitative models, statistics, execution, and risk management."
                lang={lang}
            />
            <Hero t={t} />
